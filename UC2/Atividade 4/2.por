programa
{
	funcao inicio()
	{
		...
		cadeia nomeEmpresaMB = ""
		real valorOrcamentoMB = 0.0
		...
		enquanto (desejaContinuar == 'S')
		{
			...
			se (count == 0) 
			{
				nomeEmpresaMB = nomeEmpresa
				valorOrcamentoMB = valorOrcamento
			}
			se (valorOrcamentoMB > valorOrcamento)
			{
				nomeEmpresaMB = nomeEmpresa
				valorOrcamentoMB = valorOrcamento
			}
		...
		escreva("-----------------------------------------------------------------\n")
		escreva("O orcamento mais barato calculado foi de " + nomeEmpresaMB + " no valor de: R$" + valorOrcamentoMB + "\n")
		escreva("-----------------------------------------------------------------\n")
	}
